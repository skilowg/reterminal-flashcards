    ...
    <tr>
      <td style="text-align:center; vertical-align:middle; padding:24px;">
        <div style="max-width:760px; margin:0 auto;">
         <div style="font-size:100px; font-weight:700; line-height:1.05;">${escapeHtml(word)}</div>
         <div style="font-size:44px; opacity:0.9; margin-top:21px;">${escapeHtml(furi)}</div>
         <div style="font-size:41px; margin-top:21px;">${escapeHtml(meaning)}</div>
         <div style="font-size:28px; opacity:0.8; margin-top:21px;">${escapeHtml(meta)}</div>
        </div>
      </td>
    </tr>
  </table>
